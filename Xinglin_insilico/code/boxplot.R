...
b1 = prebox(data_dir = paste0(dd,"b1/temp"), 
             key_dir = kd,
             anno = human,
             design = design,
             e_or_h = "human",
...
b2 = prebox(data_dir = paste0(dd,"b2/temp"), 
             key_dir = kd,
             anno = human,
             design = design,
             e_or_h = "human",m = seeds)

b5 = prebox(data_dir = paste0(dd,"b5/temp"), 
             key_dir = kd,
             anno = human,
             design = design,
             e_or_h = "human",m = seeds)

b10 = prebox(data_dir = paste0(dd,"b10/temp"), 
              key_dir = kd,
              anno = human,
              design = design,
              e_or_h = "human",m = seeds)
...
rows = c(91:120)
par(mfrow=c(3,4))
boxplot(b1[rows,1], b2[rows,1],b5[rows,1],b10[rows,1], main = ".4, .25, 2, 10, term 1", ylim = c(0,20))
boxplot(b1[rows,2], b2[rows,2],b5[rows,2],b10[rows,2], main = "term 2", ylim = c(0,20))
boxplot(b1[rows,3], b2[rows,3],b5[rows,3],b10[rows,3], main = "term 3", ylim = c(0,20))
boxplot(b1[rows,4], b2[rows,4],b5[rows,4],b10[rows,4], main = "term 4", ylim = c(0,20))
boxplot(b1[rows,5], b2[rows,5],b5[rows,5],b10[rows,5], main = "term 5", ylim = c(0,20))
boxplot(b1[rows,6], b2[rows,6],b5[rows,6],b10[rows,6], main = "term 6", ylim = c(0,20))
boxplot(b1[rows,7], b2[rows,7],b5[rows,7],b10[rows,7], main = "term 7", ylim = c(0,20))
boxplot(b1[rows,8], b2[rows,8],b5[rows,8],b10[rows,8], main = "term 8", ylim = c(0,20))
boxplot(b1[rows,9], b2[rows,9],b5[rows,9],b10[rows,9], main = "term 9", ylim = c(0,20))
boxplot(b1[rows,10], b2[rows,10],b5[rows,10],b10[rows,10], main = "term 10", ylim = c(0,20))
