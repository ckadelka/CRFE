...
if __name__ == '__main__':
    ...
    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            if filename.startswith("random0"):
            ...
            #    main()
                ...
                threshold, 'proportion', burnin, steps, 0.333,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/random/b3/', identifier,seed=-1,LEARN_BELIEF=False,
