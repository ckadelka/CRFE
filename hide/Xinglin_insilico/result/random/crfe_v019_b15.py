...
if __name__ == '__main__':
    ...
    directory = "/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/data/random"

    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            if filename.startswith("random1"):
            ...
            #    main()
                ...
                threshold, 'porportion', burnin, steps, 0.416,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/random/b15/', identifier,seed=-1,LEARN_BELIEF=False,
