    ...
    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            ...
            #    main()
                ...
                threshold, 'proportion', burnin, steps, 0.375,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/random/b2/', identifier,seed=-1,LEARN_BELIEF=False,
