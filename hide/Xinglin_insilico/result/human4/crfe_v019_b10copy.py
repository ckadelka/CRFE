    ...
    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            ...
            #    main()
                ...
                threshold, 'levels', burnin, steps, 0.275,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/human4/b10/', identifier,seed=-1,LEARN_BELIEF=False,
