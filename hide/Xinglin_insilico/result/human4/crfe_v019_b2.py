...
if __name__ == '__main__':
    ...
    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            if filename.startswith("human0.4_0.25_2_5_"):
            ...
            #    main()
                ...
                threshold, 'levels', burnin, steps, 0.375,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/human4/b2/', identifier,seed=-1,LEARN_BELIEF=False,
