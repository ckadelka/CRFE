...
if __name__ == '__main__':
    ...
    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            if filename.startswith("human0.4_0.25_10_10"):
            ...
            #    main()
                ...
                threshold, 'levels', burnin, steps, 0.25,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/human4/b1_temp/', identifier,seed=-1,LEARN_BELIEF=False,
                ...
                m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                threshold, 'levels', burnin, steps, 0.25,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/human4/b2_temp/', identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                (C,avgs,stds)=m.runMe(verbose=1, parameter_initial_MCMC_set=0)
                ...
                m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                threshold, 'levels', burnin, steps,0.25,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/human4/b5_temp/',identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                (C,avgs,stds)=m.runMe(verbose=1, parameter_initial_MCMC_set=0)
                ...
                m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                threshold, 'levels', burnin, steps,0.25,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/human4/b10_temp/', identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                (C,avgs,stds)=m.runMe(verbose=1, parameter_initial_MCMC_set=0)