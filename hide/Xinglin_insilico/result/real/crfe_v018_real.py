...
if __name__ == '__main__':
    ...
    steps=25000
    repeats=5
    annotation_file = '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/data/human4/human_anno.txt'
    directory = "/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/data/"

    for filename in os.listdir(directory):
        if not filename.endswith("key.txt"):
            if filename.startswith("adeno_symbol.txt"):
                f = os.path.join(directory, filename)
                l = re.findall(r"[-+]?(?:\d*\.\d+|\d+)", f)
            #    main()
                gene_file = f
                print(f)
                print(l)
                ...
                threshold, 'levels', burnin, steps, 1,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/real/b1/', identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                ...
                m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                threshold, 'levels', burnin, steps, 1,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/real/b2/', identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                (C,avgs,stds)=m.runMe(verbose=1, parameter_initial_MCMC_set=0)
                ...
                m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                threshold, 'levels', burnin, steps, 1,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/real/b5/',identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                (C,avgs,stds)=m.runMe(verbose=1, parameter_initial_MCMC_set=0)
                ...
                m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                threshold, 'levels', burnin, steps, 1,0.2,20,20, gene_file,annotation_file,
                '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/result/real/b10/', identifier,seed=-1,LEARN_BELIEF=False,
                LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False)
                (C,avgs,stds)=m.runMe(verbose=1, parameter_initial_MCMC_set=0)