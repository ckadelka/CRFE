...
if __name__ == '__main__':
    ...
    steps=50000
    repeats=1
    gene_file = '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/phenotype_relevance/GSE1297genes_copy.txt'
    #gene_file = '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/data/random/random0.txt'
    #annotation_file = '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/data/human4/human_anno.txt'
    annotation_file = '/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/phenotype_relevance/anno_GO.txt'

    belief=5
    identifier = "pheno"
    m = CRFE(repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
    threshold, 'proportion', burnin, steps, 0.25,0.25,20,20, gene_file,annotation_file,
    '/output', identifier,seed=-1,LEARN_BELIEF=False,
