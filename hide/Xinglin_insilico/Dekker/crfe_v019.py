...
class CRFE:
    ...
    def __init__(self, repeats, nr_categories, lower_cutoff, upper_cutoff, belief, 
                 ...
                 LEARN_BELIEF=False,LEARN_PENALIZATION_PARAMETER=False,penalization_parameter=0.001,GET_INFO_ON_CURRENT_SETS=False,alpha=0.1,beta=0.25):        
...
#    main()
    ...
    steps=50000
    repeats=30
    gene_file = "/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/Dekker/cortisolrankedlistG.txt"
    #gene_file = 'data/test_gene_file_keting4.txt'
    #gene_file = 'HC_RGLM_PLS_express_tab.txt'
    annotation_file = "/Users/JasonJia/Desktop/CRFE/Xinglin_insilico/Dekker/Fazhir_GO_cleanG.txt"
