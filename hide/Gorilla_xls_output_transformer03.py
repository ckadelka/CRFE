...
identifier = "liver_gorilla" if disease_name=="Liver" else ("ncbi"+disease_name[3:]+"_gorilla" if 'gds'==disease_name.lower()[:3] else "lung_cancer_gorilla")
...
for min_level in [30]:
    ...
    #a=gr.plot_jaccard_term_by_term2a([C],m.T,[],m.G,m,min_level=30,cutoff=10,kind=1,colors=[gr.rgb('e')],title="GOrilla",identifier=identifier,SAVE=True,fontsize=54)
    #a=gr.plot_jaccard_term_by_term2a([C],m.T,[],m.G,m,min_level=30,cutoff=20,kind=1,colors=[gr.rgb('e')],title="GOrilla",identifier=identifier,SAVE=True,fontsize=54)
    #a=gr.plot_jaccard_term_by_term2a([C],m.T,[],m.G,m,min_level=30,cutoff=40,kind=1,colors=[gr.rgb('e')],title="GOrilla",identifier=identifier,SAVE=True,fontsize=54)
