...
#save data
#if m.go_file=='msigdb.txt':
#    f=open('saved_data/multiple_runs_msigdb_'+m.out_str+'_s'+str(m.s)+'_cutoff'+str(m.cutoff)+'_topcutoff'+str(m.top_cutoff)+'_nsim'+str(nsim)+'.txt','w+')
#else:
#    f=open('saved_data/multiple_runs_go_'+m.out_str+'_s'+str(m.s)+'_cutoff'+str(m.cutoff)+'_topcutoff'+str(m.top_cutoff)+'_nsim'+str(nsim)+'.txt','w+')    
#pickle.dump([C,MCMC_distr], f)
#f.close()

##load data
if m.go_file=='msigdb.txt':
    f=open('saved_data/multiple_runs_msigdb_'+m.out_str+'_s'+str(m.s)+'_cutoff'+str(m.cutoff)+'_topcutoff'+str(m.top_cutoff)+'_nsim'+str(nsim)+'.txt','rb')
else:
    f=open('saved_data/multiple_runs_go_'+m.out_str+'_s'+str(m.s)+'_cutoff'+str(m.cutoff)+'_topcutoff'+str(m.top_cutoff)+'_nsim'+str(nsim)+'.txt','rb')    
[C,MCMC_distr]=pickle.load(f)
f.close()